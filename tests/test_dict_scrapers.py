...
@pytest.mark.parametrize('word, defs', [
    ('cat', [
        '(noun) a small animal with soft fur that people often keep as a pet. '
    ...
    ('rub', [
        ...
        '(verb) to press two surfaces against each other and move them backwards and forwards; '
        'to be pressed together and move in this way',
        '(verb) to move backwards and forwards many times against something '
        'while pressing it, especially causing pain or damage',
        '(verb) to spread a liquid or other substance over a surface while pressing it',
