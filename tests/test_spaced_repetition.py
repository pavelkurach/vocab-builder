...
states = {
    "Forgot": SpacedRepetition.states[0],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            penultimate_bucket_number,
            states["Recalled easily"],
            last_bucket_number,
        ),
    ],
)
def test_spaced_repetition_scheduler(bucket, state, new_bucket):
    assert (
        SpacedRepetition.spaced_repetition_scheduler(
